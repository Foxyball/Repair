...
public class Loading extends javax.swing.JFrame implements Runnable {
    ...
    public void run() {
        try {
            for (int i = 1; i <= 200; i++) {
                ...
                if (currentValue < jProgressBar1.getMaximum()) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Моля изчакайте...");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/repair/assets/loading.gif"))); // NOI18N
